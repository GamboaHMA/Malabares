...
class Cascade5(Malabar):
    ...
    def indice_inicial_pelota_mano(self, pelota, totalPelotas):
        ...
        for i in range(totalPelotas):
            new_pelota = Pelota(pelota.pos, pelota.radio, pelota.color, pelota.recorrido)
            new_pelota.index_inicio = i * rango_entre_pelotas
            self.pelotas.append(new_pelota)

        self.mano2.index_inicio = 2*rango_entre_pelotas
        self.mano1.index_inicio = 10*rango_entre_pelotas
    ...
    def calcularArrayDeSpeedsMano(self, pelota: Pelota, mano: Mano, totalPelotas):
        total_iteraciones_pelota = int(len(pelota.recorrido)/4) # 185
        total_iteraciones_mano = len(mano.recorrido)

        result = []

        for i in range(total_iteraciones_pelota):
            if i >= total_iteraciones_mano:
                result.append(0)
            else:
                result.append(1)
...
class Cascade6(Malabar):
    ...
    def indice_inicial_pelota_mano(self, pelota, totalPelotas):
        ...
        pelota1.index_inicio = 0
        pelota2 = Pelota((-25,-25), 25, azul, self.pelota1.recorrido)
        pelota2.index_inicio = (len(pelota2.recorrido)//6)
        pelota3 = Pelota((-25,-25), 25, azul, self.pelota1.recorrido)
        pelota3.index_inicio = (len(pelota2.recorrido)//6)*2 #+ (len(pelota2.recorrido)//6)//4

        pelota4 = Pelota((-25,-25), 25, azul, self.pelota2.recorrido)
        pelota4.index_inicio = len(self.pelota1.recorrido)//6 - (len(self.pelota1.recorrido)//6)//2
        pelota5 = Pelota((-25,-25), 25, azul, self.pelota2.recorrido)
        pelota5.index_inicio = (len(pelota4.recorrido)//6) + (len(self.pelota1.recorrido)//6)//2 
        pelota6 = Pelota((-25,-25), 25, azul, self.pelota2.recorrido)
        pelota6.index_inicio = (len(pelota4.recorrido)//6)*2 + (len(self.pelota1.recorrido)//6)//2

        self.pelotas.append(pelota1)
        self.pelotas.append(pelota2)
        self.pelotas.append(pelota3)
        self.pelotas.append(pelota4)
        self.pelotas.append(pelota5)
        self.pelotas.append(pelota6)
...
class Cascade3Inverso(Malabar):
    ...
    def pelotas_totalPelotas_manos(self):
        ...
        recorrido = [
             (parabola_izq_der1, True),
             (parabola_izq_der2, True),
             (parabola_izq_der3, False),
             (parabola_izq_der4, False),
             ]
        
        mano1_recorrido = parabola_izq_der1.puntosDeRecorrido([(parabola_izq_der4, False),(mano1_parabola, True)])
        mano2_recorrido = parabola_izq_der1.puntosDeRecorrido([(parabola_izq_der2, True), (mano2_parabola, False)])

        puntos_de_recorrido = parabola_izq_der1.puntosDeRecorrido(recorrido=recorrido)
    ...
    def indice_inicial_pelota_mano(self, pelota, totalPelotas):
        ...
        self.mano1.index_inicio = 0
        self.mano2.index_inicio = 5*rango_entre_pelotas
...
class Circular3(Malabar):
    def __init__(self):
        super().__init__()

    def pelotas_totalPelotas_manos(self):

        parabola_izq_der1 = Parabola((660, 140), 0.01, 0, (-185, 185), mod1=1.0)
        parabola_izq_der2 = Parabola((804, 502), 0.01, 0, (-40, 40), inversa=True)
        parabola_izq_der3 = Parabola((660, 440), 0.01, 0, (-100, 100), mod2=0.05)
        parabola_izq_der4 = Parabola((515, 506), 0.01, 0, (-40, 40), inversa=True)


        mano1_parabola = Parabola((804, 502-50), 0.01, 0, (-40, 40))
        mano2_parabola = Parabola((515, 506-50), 0.01, 0, (-40, 40))
        ...
        mano1_recorrido = parabola_izq_der1.puntosDeRecorrido([(parabola_izq_der4, True), (mano2_parabola, False)])
        mano2_recorrido = parabola_izq_der1.puntosDeRecorrido([(mano1_parabola, False),(parabola_izq_der2, True)])
